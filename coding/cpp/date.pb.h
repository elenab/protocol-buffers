...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_date_2eproto;
namespace date {
class Date;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::date::Date* Arena::CreateMaybeMessage<::date::Date>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace date {
...
class Date PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:date.Date) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_date_2eproto);
    return ::descriptor_table_date_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Date::year() const {
  // @@protoc_insertion_point(field_get:date.Date.year)
...
inline void Date::set_year(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:date.Date.year)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Date::month() const {
  // @@protoc_insertion_point(field_get:date.Date.month)
...
inline void Date::set_month(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:date.Date.month)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Date::day() const {
  // @@protoc_insertion_point(field_get:date.Date.day)
...
inline void Date::set_day(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:date.Date.day)
}
